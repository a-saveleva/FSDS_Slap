...
for date in airbnbdates:
    ...
    print(f"Data frame from date {date} is {airbnbdfs[0].shape[0]:,} x {airbnbdfs[0].shape[1]}")

airbnb_old, airbnb_new = airbnbdfs #airbnb_old is the earlier scrape, and new is the later scrape. We don't hardcode the dates for reproducibility with other dates and times.
```
