...
for idx, item in enumerate(csv_dict["raw_csvs_fn"]):
    df = pd.read_csv(os.path.join('data','raw', f"{item}.csv"), 
...
```{python}
# #| echo: false
# def substract_gdfs(gdf_old, gdf_new, cols):
#     """
...
#     for col in cols:
#         gdf_diff[col] = gdf_new[col] - gdf_old[col]
...
# diff2024_2023_boro = substract_gdfs(airbnb_2023_boro[0], airbnb_2024_boro[0], cols_diff_airbnb)
# diff2024_2023_lsoa = substract_gdfs(airbnb_2023_lsoa[0], airbnb_2024_lsoa[0], cols_diff_airbnb)
```
...
# #| echo: false
#_____________________________________________________________________________________________________________________________
# I MADE A COLUMN WITH THE DIFFERENCE
# LETS DISCUSS IF WE WANT TO USE VALUES NORMALISED BY AREA, OR BY DIFFERENCE BETWEEN 2 DATES
#_____________________________________________________________________________________________________________________________
...
# diff2024_2023_boro.plot(column='total_entireha', ax=axes[0], legend=True,
#                     legend_kwds={'label': "Difference in Points by Area",
#                                  'orientation': "horizontal"},
#                     cmap='Reds', edgecolor='black')

# # Add title and labels
# axes[0].set_title("Difference in count of the AirBnb locations available as \"Entire home/apt\" rentals by Borough, 2024-2023", fontsize=8)
...
# # Add title and labels
# axes[1].set_title("Difference in count of the AirBnb locations available as \"private room\" rentals by Borough, 2024-2023", fontsize=8)
...
#                         legend_kwds={'label': "Difference in Points by Area",
#                                      'orientation': "horizontal"},
#                         cmap='Spectral_r', edgecolor='black',
...
# Add title and labels
axes[0].set_title("Relative Percentage Difference in count of the AirBnb locations available as \"Entire home/apt\" rentals by Borough, 2024-2023", fontsize=8)
axes[0].set_xlabel("Longitude")
axes[0].set_ylabel("Latitude")
...
```{python}
#______________ merging the data for the regression model __________
...
Regresion_Final = Regression_Final.drop(columns=['mnemonic'], errors = 'ignore')
