...
| -------------- | -------------------- |
| A We identified the project scope early, and spent most of the time on interpretation, discussion and refinements to EDA   | B Interpretation of residuals |
| C  We are seeing some impact which we expected to see | D     Cleaning and deduplicating the InsideAirbnb dataset |
