...
Data is scraped quarterly from Airbnb's public site using open-source tools - Python and PostgreSQL [@tomslee]. The process involves verification, cleansing, analysis, and aggregation. These are the assumptions, since the scripts are unavailable.
